    ...
    <section id="menu" className="scroll-mt-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex items-end justify-between">
          <div>
            <span className="font-display text-xs uppercase tracking-[0.1em] text-amber">
              Explore Our Kitchen
            </span>
            <h2 className="mt-2 font-display text-4xl uppercase tracking-[0.03em] text-white md:text-5xl">
              The fuel line
            </h2>
        ...
        {/* Mobile (<lg): one card slides with symmetric peek on both sides */}
