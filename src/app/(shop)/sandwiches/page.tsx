...
import { SandwichesGrid } from "@/features/sandwiches/components/SandwichesGrid";
import { OtherLanes } from "@/components/shared/OtherLanes";

const SLUG = "sandwiches";

const category = getCategoryBySlug(SLUG);

export const metadata: Metadata = pageMetadata({
  path: "/sandwiches",
  title: category?.name ?? "Sandwiches",
  description: `${category?.blurb ?? ""}. Explore the ${category?.name ?? "Sandwich"} menu at Burger Fuel, Shad Bagh, Lahore.`,
  image: category?.image,
});

export default function SandwichesRoute() {
