...
import { NewArrivalsGrid } from "@/features/new-arrivals/components/NewArrivalsGrid";
...
export const metadata: Metadata = pageMetadata({
  ...
  description: `${category?.blurb ?? "Fresh drops just hit the menu"}. Explore the New Arrivals menu at Burger Fuel, Shad Bagh, Lahore.`,
