...
import { CrunchMunchGrid } from "@/features/crunch-munch/components/CrunchMunchGrid";
import { OtherLanes } from "@/components/shared/OtherLanes";

const SLUG = "crunch-and-munch";

const category = getCategoryBySlug(SLUG);

export const metadata: Metadata = pageMetadata({
  path: "/crunch-and-munch",
  title: category?.name ?? "Crunch & Munch",
  description: `${category?.blurb ?? ""}. Explore the ${category?.name ?? "Crunch & Munch"} menu at Burger Fuel, Shad Bagh, Lahore.`,
  image: category?.image,
});

export default function CrunchAndMunchRoute() {
