...
import { PastasGrid } from "@/features/pastas/components/PastasGrid";
...
export const metadata: Metadata = pageMetadata({
  path: "/pastas",
  title: category?.name ?? "Pasta's",
  description: `${category?.blurb ?? ""}. Explore the ${category?.name ?? "Pasta"} menu at Burger Fuel, Shad Bagh, Lahore.`,
  image: category?.image,
});

export default function PastasRoute() {
