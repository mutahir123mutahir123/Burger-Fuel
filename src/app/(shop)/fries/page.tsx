...
import { FriesGrid } from "@/features/fries/components/FriesGrid";
...
export const metadata: Metadata = pageMetadata({
  path: "/fries",
  title: category?.name ?? "Fries",
  description: `${category?.blurb ?? "Golden, crispy & loaded"}. Explore the Fries menu at Burger Fuel, Shad Bagh, Lahore.`,
  image: category?.image,
});

export default function FriesRoute() {
